...
- ""
date: "2020-10-09"
description: Youth behavior
draft: false
image: project4/youth.jpg
keywords: ""
slug: project_4
title: Let's see the trend youth is following!
---
...
```{r, summary_yrbss, fig.width=12, warning=FALSE, message=FALSE}
...
```{r, eda_on_weight, warning=FALSE, message=FALSE}
...
```{r, ci_not_active, warning=FALSE, message=FALSE}
...
```{r, test_initialization, warning=FALSE, message=FALSE}
obs_diff <- yrbss %>%
